...
export const inventoryItemSchema = z.object({
  ...
  updatedAt: z.date().optional().nullable(), // Tambahkan field updatedAt
  originalIndex: z.number().optional(), // DIKEMBALIKAN: Tambahkan properti ini
});
...
export const headerMapping: Record<keyof InventoryItem, string> = {
    ...
    updatedAt: 'Terakhir Diperbarui', // Pastikan ini ada
    originalIndex: 'No.', // DIKEMBALIKAN: Tambahkan ke mapping
};
